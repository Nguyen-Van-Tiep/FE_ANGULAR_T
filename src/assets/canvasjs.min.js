...
(function () {
    ...
    w && ab
      ? ((va =
          !r(va) && va
            ...
            : h.getContext("2d")),
        (Oa =
          va.webkitBackingStorePixelRatio ||
          va.mozBackingStorePixelRatio ||
          va.msBackingStorePixelRatio ||
          va.oBackingStorePixelRatio ||
          va.backingStorePixelRatio ||
          1),
        (ia = Sa / Oa),
        (h.width = n * ia),
        (h.height = E * ia),
  ...
  function ib(h) {
    if (!jb) {
      ...
      "undefined" === typeof oa.Chart.creditHref
        ? ((h.creditHref = W("iuuqr;..b`ow`rkr/bnl.")),
          (h.creditText = W("B`ow`rKR/bnl")))
  ...
  function pa(h, n, E) {
    ...
    n.getAttribute("state") !== E &&
      (n.setAttribute("state", E),
      ...
      (n.innerHTML =
        ...
        kb[E].image +
        "' alt='" +
        h._cultureInfo[E + "Text"] +
        "' />"),
      S(n.childNodes[0], { height: "95%", pointerEvents: "none" }));
  ...
  var gb = (function () {
        ...
        return (P = J.replace(h, function (l) {
          switch (l) {
            ...
            case "K":
              return S
                ? "UTC"
                : (String(B).match(U) || [""]).pop().replace(A, "");
            case "z":
        ...
        if (((n = B[N]), "." === n && 0 > J)) J = N;
          ...
          if ("%" === n) A *= 100;
            ...
            ("E" !== n[0] && "e" !== n[0]) ||
              ...
              (S = !0);
          0 > J
            ? (P.push(n), "#" === n || "0" === n ? O++ : "," === n && I++)
            : (R.push(n), ("#" !== n && "0" !== n) || K++);
        }
      S &&
        ((n = Math.floor(h)),
        (B = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (X = 0 === h ? 0 : 0 === n ? -(O + B) : nb(n).length - O),
        (A /= Math.pow(10, X)));
      0 > J && (J = N);
      A = (h * A).toFixed(K);
      n = A.split(".");
        ...
        if (((n = P.pop()), "#" === n || "0" === n))
          if ((J++, J === O)) {
            ...
            for (; 0 < $.length; )
              (r = $.pop() + r),
                S++,
                0 === S % B && N === I && 0 < $.length && (r = U + r);
          } else
            0 < A.length
              ? ((r = A.pop() + r), K++, S++)
              : "0" === n && ((r = "0" + r), K++, S++),
              0 === S % B && N === I && 0 < A.length && (r = U + r);
        else
          ("E" !== n[0] && "e" !== n[0]) ||
          "0" !== n[n.length - 1] ||
          !/[eE][+-]*[0]+/.test(n)
            ? "," === n
              ? (N++, (B = S), (S = 0), 0 < A.length && (r = U + r))
              : (r =
                  1 < n.length &&
                  (('"' === n[0] && '"' === n[n.length - 1]) ||
                    ("'" === n[0] && "'" === n[n.length - 1]))
    ...
    ba = function (h, n, r, w, v, B, A, J, O, P, R, S, K) {
      ...
      0 < A &&
        ...
        (h.strokeStyle = J),
        h.moveTo(n, r),
        h.rect(n - K, r - K, w - n + 2 * K, v - r + 2 * K),
        h.stroke());
      h.restore();
      !0 === O &&
        (h.save(),
        ...
        h.lineTo(w, r),
        h.closePath(),
        (A = h.createLinearGradient((w + n) / 2, r + I, (w + n) / 2, r)),
        A.addColorStop(0, B),
      ...
      !0 === P &&
        ...
        h.lineTo(w, v),
        h.closePath(),
        (A = h.createLinearGradient((w + n) / 2, v - I, (w + n) / 2, v)),
        A.addColorStop(0, B),
        A.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (h.fillStyle = A),
        h.fill(),
      ...
      !0 === R &&
        ...
        h.lineTo(n, v),
        h.closePath(),
        (A = h.createLinearGradient(n + I, (v + r) / 2, n, (v + r) / 2)),
        A.addColorStop(0, B),
  ...
  X.prototype.updateOption = function (h) {
    ...
    var n = oa[this._defaultsKey],
      ...
      U = this._index;
    this.theme && r(this.parent) && r(B) && r(U)
      ...
      : this.parent &&
        ...
        (null === U
          ...
          : 0 < this.parent.themeOptions[B].length &&
            ((w = Math.min(this.parent.themeOptions[B].length - 1, U)),
  ...
  var Qa = {
    ...
    formatNumber: function (h, n, r) {
      r = r || "en";
      if (La[r]) return fa(h, n || "#,##0.##", new Ka(r));
  ...
  v = Qa.Chart = (function () {
    ...
    function U(a, d, c, b) {
      U.base.constructor.call(this, "DataSeries", "data", d, c, a);
      this.chart = a;
      this.canvas = a.canvas;
            ...
            m._animator.animate(
              ...
              function (a) {
                ...
                m.ctx.drawImage(
                  ...
                  0,
                  0,
                  Math.floor(m.width * ia),
                  Math.floor(m.height * ia),
                  0,
                  0,
                  m.width,
                  m.height
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
            var ca = a.axisX.sessionVariables.newViewportMinimum
                ? a.axisX.sessionVariables.newViewportMinimum
                : a.axisX.options && a.axisX.options.viewportMinimum
                ? a.axisX.options.viewportMinimum
                : a.axisX.options && a.axisX.options.minimum
          ...
          for (q = 0; q < p.dataPoints.length; q++) {
            ...
            if (0 < q) {
              ...
              null !== e &&
                ...
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((n = e / p.dataPoints[q - 1].y),
                    1 > n && (n = 1 / n),
                    d.minDiff > n && 1 !== n && (d.minDiff = n))
                  : ((n = e - p.dataPoints[q - 1].y),
                    0 > n && (n *= -1),
                    d.minDiff > n && 0 !== n && (d.minDiff = n)));
            }
    ...
    n.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var n = la("indexLabelLineDashType", m.dataPoint, m.dataSeries),
          ...
          y = r(m.dataPoint.indexLabelLineThickness)
        ...
        if (null !== G && "" !== G) {
          ...
          y &&
            ...
            d.setLineDash && d.setLineDash(J(n, y)),
            d.beginPath(),
        ...
        for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < m.length) {
            for (var z = !1, u = 0; u < m.length; u++)
              if (
                ((r = m[u].x.getTime ? m[u].x.getTime() : m[u].x),
                !(
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < m.length) {
            for (var z = !1, u = 0; u < m.length; u++)
              if (
                ((r = m[u].getTime ? m[u].x.getTime() : m[u].x),
                !(
                  r < a.axisX.dataInfo.viewPortMin ||
                  (r > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !z))
    ...
    n.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < u.length)
            for (
              var n = 5 < s && r.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
              ...
              if (
                ...
                "number" !== typeof s[r].y
                  ...
                  : ((n = a.axisX.convertValueToPixel(y)),
                    ...
                    r < s.length - 1 &&
                      (A !== (s[r].lineColor || v) ||
                        M !== (s[r].lineDashType || g.lineDashType)) &&
                      (b(),
                      (A = s[r].lineColor || v),
                      (f.strokeStyle = A),
                      f.setLineDash &&
                        (s[r].lineDashType
                          ...
                          : ((M = g.lineDashType), f.setLineDash(E)))),
                    (y = g.dataPointIds[r]),
                    ...
                    0 !== s[r].markerSize &&
                      ...
                      ((aa = g.getMarkerProperties(r, n, u, f)),
                      h.push(aa),
                      (y = O(y)),
                      w &&
                        h.push({
            ...
            for (var aa = !0, q = 0; q < m.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof ha.y)
                  ...
                  q < v.length - 1 &&
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ...
                        : ((x = C.lineDashType), b.setLineDash(E))));
                  ...
                  0 <= C.dataPointIndexes[f] &&
                    0 !== ha.markerSize &&
                    (0 < ha.markerSize || 0 < C.markerSize) &&
          ...
          if (0 < m.length) {
            ...
            for (var aa = !0, q = 0; q < m.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof ha.y)
                  C.connectNullData || aa || n || d(), (aa = !0);
                else {
                  var ma;
                  ma =
                    0 !== a.dataPointYSums[f]
                      ? 100 * (ha.y / a.dataPointYSums[f])
                      : 0;
                  g = a.axisX.convertValueToPixel(f);
                  var B = h[f] ? h[f] : 0;
                  if (
                  ...
                  q < v.length - 1 &&
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ...
                        : ((u = C.lineDashType), b.setLineDash(E))));
                  if (0 <= C.dataPointIndexes[f]) {
                  ...
                  0 <= C.dataPointIndexes[f] &&
                    0 !== ha.markerSize &&
                    (0 < ha.markerSize || 0 < C.markerSize) &&
                    ((B = C.getMarkerProperties(q, g, s, b)),
                    t.push(B),
                    (f = O(F)),
                    w &&
                      t.push({
    ...
    n.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var n = !1, n = !!a.axisY.reversed, ca = 0;
          ca < a.dataSeriesIndexes.length;
          ca++
        ) {
            ...
            for (
              ...
              if (
                ...
                0 < Ba &&
                  ...
                  (c.strokeStyle = ma),
                  (c.lineWidth = Ba),
                  c.setLineDash && c.setLineDash(J(I, Ba)),
                  c.moveTo(t - F, k),
                  c.lineTo(t - F, h),
                  c.stroke(),
                  c.moveTo(t - F, p),
                ...
                0 < P &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(J(R, P)),
                  (c.strokeStyle = K),
                  (c.lineWidth = P),
                  c.moveTo(v, q - L),
                  c.lineTo(C, q - L),
                ...
                0 < T &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(J(E, T)),
                  (c.strokeStyle = M),
                  (c.lineWidth = T),
                  c.moveTo((t - aa / 2) << 0, p - ha),
                  c.lineTo((t + aa / 2) << 0, p - ha),
                  c.stroke(),
                  c.moveTo((t - aa / 2) << 0, h + ha),
                  c.lineTo((t + aa / 2) << 0, h + ha),
                  c.stroke());
                c.restore();
                w &&
                  ((e = O(Q)),
                  ...
                  0 < T &&
                    (b.beginPath(),
                    (b.lineWidth = T),
                    b.moveTo(t + aa / 2, p - ha),
                    b.lineTo(t - aa / 2, p - ha),
                    b.stroke(),
                    b.moveTo(t + aa / 2, h + ha),
                    b.lineTo(t - aa / 2, h + ha),
                    b.stroke()));
                (x[l].indexLabel ||
                  y.indexLabel ||
          ...
          if (0 < g.length)
            for (
              ...
              if (
                ...
                ba(
                  c,
                  a.axisX.reversed ? ca : n,
                  l,
                  a.axisX.reversed ? n : ca,
                  t,
                  b,
                  0,
                  b,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var ca = 0, u = 0; u < this.data.length; u++)
          !this.data[u].type.match(/(bar|column)/gi) ||
            !this.data[u].visible ||
            (this.data[u].type.match(/(stacked)/gi) && ca) ||
            ca++;
        for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
          ...
          t = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (C ? ca : 1))
              ) << 0
            : 0.3 * this.width;
          f &&
            (t = this.options.dataPointMaxWidth
          ...
          if (0 < v.length)
            for (var E = z._colorSet, t = 0; t < v.length; t++) {
              ...
              if (
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (k + ((C ? ca : 1) * u) / 2 - (C ? A - 1 : 0) * u) << 0
                      : (k - ((C ? ca : 1) * u) / 2 + (C ? A - 1 : 0) * u) <<
                        0),
                    (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                  : ((m = a.axisX.reversed
                      ? (h + ((C ? ca : 1) * u) / 2 - (C ? A - 1 : 0) * u) << 0
                      : (h - ((C ? ca : 1) * u) / 2 + (C ? A - 1 : 0) * u) <<
                        0),
    ...
    n.prototype.renderFunnel = function (a) {
        ...
        if (e)
          for (l = H.length - 1; 0 <= l; l--)
            (a = Q[l]),
              ...
              u.reversed
                ? (H[l].textBlock.y + H[l].height > V + z &&
                    (H[l].textBlock.y = V + z - H[l].height),
                  H[l].textBlock.y < qa - z && (H[l].textBlock.y = qa - z))
                : (H[l].textBlock.y < V - z && (H[l].textBlock.y = V - z),
                  H[l].textBlock.y + H[l].height > qa + z &&
                    (H[l].textBlock.y = qa + z - H[l].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < Q.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = Q[e]),
                ...
                u.reversed
                  ? (H[e].textBlock.y + H[e].height > V + z &&
                      (H[e].textBlock.y = V + z - H[e].height),
                    H[e].textBlock.y < qa - z && (H[e].textBlock.y = qa - z))
                  : (H[e].textBlock.y < V - z && (H[e].textBlock.y = V - z),
                    H[e].textBlock.y + H[e].height > qa + z &&
                      (H[e].textBlock.y = qa + z - H[e].height)));
        else
      ...
      function l() {
          ...
          for (var l, h = 1; h < k; h++) {
            ...
            for (var t = H.length - 1; 0 <= t; t--)
              !H[t].isDirty &&
                ...
                ((l = q(t)),
                !(l >= H.length - 1) &&
                  H[t].textBlock.y + H[t].height + ea > H[l].textBlock.y &&
                  (H[t].textBlock.y =
        ...
        for (var d, e, f, g, k, l, m = 1, n = 0; n < 2 * m; n++) {
          for (
            ...
            (f = H[s]),
            (g = f.textBlock),
            (l = (k = q(s) < Q.length ? H[q(s)] : null) ? k.textBlock : null),
      ...
      function h(a, b) {
        return (
          (b < Q.length ? H[b].textBlock.y : u.reversed ? V + z : qa + z) -
          (0 > a
            ? u.reversed
              ? qa - z
              : V - z
      ...
      function n(a, b, c) {
        ...
        if (0 === W.length) l = ia;
          ...
          e =
            (z *
              (1 != W.length || (0 != W[0] && W[0] != Q.length - 1) ? 2 : 1)) /
            k();
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          "funnel" === u.type
            ? ((O = r(u.options.neckHeight) ? 0.35 * E : u.neckHeight),
              ...
              F > a ? (F = a - 0.5) : 0 >= F && (F = 0))
            : "pyramid" === u.type &&
              ((F = O = 0), (u.reversed = u.reversed ? !1 : !0));
          var B = T + a / 2,
            X = T,
            Z = T + a,
            V = u.reversed ? R : P,
          ...
          if (-1 !== T) {
            if (u.reversed)
              for (I.push(Y), F = T.length - 1; 0 < F; F--)
                (Y += T[F]), I.push(Y);
            else for (F = 0; F < T.length; F++) (Y += T[F]), I.push(Y);
            if (u.reversed)
              for (F = 0; F < T.length; F++)
                I[F] < Ca
                  ? (a.push(L), B.push($), (da = F))
                  : (a.push((I[F] - V + ba * X) / ba),
                    B.push((I[F] - V + fa * Z) / fa));
            else
              for (F = 0; F < T.length; F++)
                I[F] < Ca
                  ? (a.push((I[F] - V + ba * X) / ba),
            ...
            for (F = 0; F < y.length; F++)
              y[F].exploded &&
                ((T = !0), u.reversed ? W.push(y.length - 1 - F) : W.push(F));
            ...
            M &&
              u.visible &&
              ("inside" === u.indexLabelPlacement || A.animationEnabled || m(U),
            ...
            var q = (p.legendMarkerType = p.legendMarkerType
                ...
                ? "error" === p.type && p._linkedSeries
                  ? p._linkedSeries.legendMarkerType
                    ? p._linkedSeries.legendMarkerType
                    : U.getDefaultLegendMarker(p._linkedSeries.type)
                  : U.getDefaultLegendMarker(p.type)
                : p.markerType),
              g = p.legendText
                ? p.legendText
            ...
            if (((c = this.logLabelValues[b]), c < this.viewportMinimum)) b++;
              ...
              a ||
                ((a = this.labelFormatter
                  ...
                  ? this.labels[m]
                  : fa(m, this.valueFormatString, this.chart._cultureInfo)),
                (a = new ka(this.ctx, {
                  x: 0,
                  y: 0,
                  maxWidth: f,
            ...
            for (g = 0; g < d.length; g++)
              (d[g].lineCoordinates.x1 = Math.round(f.x1 + Q + L)),
                ...
                m.panEnabled
                  ...
                  : (m.sessionVariables.axisX2.height = Y),
                (h = Math.round(f.y1)),
                (k = d[g].lineCoordinates.y1 = h + Y + X - U),
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (n = Math.round(
                  f.x2 - W - X > m.width - 10 ? m.width - 10 : f.x2 - W - X
                )),
                c[g].labelAutoFit &&
                  !r(y) &&
                  (0 < !a.length &&
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((n = b[L].lineCoordinates.x2), (l = n - W));
              d[g].lineCoordinates = {
                x1: n + R,
                y1: h,
                x2: n + R,
    ...
    A.prototype.renderCrosshair = function (a, d) {
      isFinite(this.minimum) &&
        ...
        this.crosshair.dispatchEvent(
          ...
          {
            chart: this.chart,
            crosshair: this.crosshair.options,
            axis: this,
    ...
    A.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      h = Math.pow(
        this.logarithmBase,
        A.getNiceNumber(Math.abs(Math.log(h) / d), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = A.getNiceExponent(Math.log(h) / d / (a - 1), !0)),
          (c = A.getNiceNumber(n / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          "axisX" === this.type
            ? b / Math.sqrt(f)
